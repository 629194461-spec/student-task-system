...
try {
  ...
  await run(process.execPath, ['--test', 'tests/task-templates.test.mjs', 'tests/account-system.test.mjs', 'tests/storage-migration.test.mjs'], { env: { ...process.env, TEST_BASE_URL: base } });
} finally {
